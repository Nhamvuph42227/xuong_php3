        ...
        <div class=" mb-lg-0 mb-4 ">
            <div class="card z-index-2 h-100">
                ...
                <div class="d-flex justify-content-end ">
                    <a class="btn btn-success mx-4" href="{{ route('admins.baiviets.create') }}">Thêm mới bài viết</a>
                </div>
                <div class="row">
                    <div class="col-xl-12">
                        @if (session('success'))
                                ...
                                <table class="table  align-items-center ">
                                    ...
                                    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center" style="max-width: 200px; overflow: hidden;">{{$item->ten_bai_viet}}</td>
