                                ...
                                <form action="{{route('clients.shop')}}" method="GET">
                                    <div class="input-group">
                                        <select class="nice-select" name="filter">
                                            ...
                                            <option value="favorite" {{request('filter') == 'favorite' ? 'selected' : ''}}>Sản Phẩm Yêu Thích</option>
                                            <option value="best_seller" {{request('filter') == 'best_seller' ? 'selected' : ''}}>Sản Phẩm Bán Chạy</option>
                                        </select>
